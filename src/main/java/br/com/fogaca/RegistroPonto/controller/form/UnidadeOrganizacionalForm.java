...
public class UnidadeOrganizacionalForm {
	...
	public UnidadeOrganizacional converter() {
		return new UnidadeOrganizacional(descricao, cnpj, abertura, ativo, telefone, cep, rua, numero, bairro, cidade, estado, horaFuncionaInicio, horaFuncionaFim);
	}
