...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/usuarios/id/**").hasAnyRole(responsavelRh,colaborador)
		.antMatchers(HttpMethod.GET, "/usuarios/email/**").hasAnyRole(responsavelRh,colaborador)
		.antMatchers(HttpMethod.PUT, "/usuarios/**").hasAnyRole(responsavelRh,colaborador)
		...
		.antMatchers(HttpMethod.POST, "/colaboradores").hasAnyRole(responsavelRh,colaborador)
		.antMatchers(HttpMethod.GET, "/colaboradores/**").hasAnyRole(responsavelRh,colaborador)
		.antMatchers(HttpMethod.PUT, "/colaboradores/**").hasAnyRole(responsavelRh,colaborador)
		...
		.antMatchers(HttpMethod.GET, "/unidades/**").hasAnyRole(responsavelRh,colaborador)
		...
		.antMatchers(HttpMethod.GET, "/registros/**").hasAnyRole(responsavelRh,colaborador)
		.antMatchers(HttpMethod.POST, "/registros").hasAnyRole(responsavelRh,colaborador)
